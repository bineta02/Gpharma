...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logopharma">
        <img src="{{asset('assets/img/logo.jpeg')}}" alt="" width="50px">
        <span class="d-none d-lg-block">G-Pharma</span>
      </a>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Binette</span></strong>. All Rights Reserved
    </div>
