  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-8">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Modifier : {{ $produit->nom }}</h5>

            <!-- Formulaire connecté à la route Update -->
            <form action="{{ route('produits.update', $produit->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $produit->code) }}" required>
  ...
  <div class="col-sm-10">
    <input type="number" name="prix" id="prix" class="form-control" value="{{ old('prix', $produit->prix) }}" min="0" required>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-3">
                  <input type="number" name="stock_min" class="form-control @error('stock_min') is-invalid @enderror" value="{{ old('stock_min', $produit->stock_min) }}" required>
                ...
                <div class="col-sm-3">
                  <input type="number" name="stock_max" class="form-control @error('stock_max') is-invalid @enderror" value="{{ old('stock_max', $produit->stock_max) }}" required>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  @if($produit->image)
                    <div class="mb-2">
                      <img src="{{ asset('storage/' . $produit->image) }}" alt="Image actuelle" class="img-thumbnail" style="max-width: 100px;">
                    </div>
                  @endif
